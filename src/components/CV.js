...
const CV=()=>{
    return(
        <div className='container' id='cv'> 
            <h4 className="text-uppercase text-center text-info text-icon"><img src="http://icons.iconarchive.com/icons/inipagi/job-seeker/72/cv-icon.png" alt="demo"/><b>CV</b></h4>            
